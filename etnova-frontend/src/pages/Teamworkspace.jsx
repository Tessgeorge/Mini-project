                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-2">
                      ...
                      <span className="text-[11px] text-gray-500 font-semibold">{mentorName || "Mentor"}</span>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-5 py-3 bg-gray-50 border-t border-gray-100">
          <p className="text-xs text-gray-400 flex items-center gap-1.5">
            <Ic.Info />
            Coordinator-set student submission deadlines for this class
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                  ...
                  <div className="text-right flex-shrink-0 ml-2">
                    ...
                    {milestoneDates?.[i] && (
                      <p className="text-[10px] text-gray-400 mt-0.5">
                        {new Date(milestoneDates[i]) < new Date() ? "Past due" : "Upcoming"}
                      </p>
                    )}
                  </div>
                </div>
      ...
      <div className="px-5 py-3 bg-gray-50 border-t border-gray-100">
        <p className="text-xs text-gray-400 flex items-center gap-1.5">
          <Ic.Info />
          {milestoneDates?.some(Boolean) ? "Admin milestone deadlines" : "No deadlines set yet - contact admin"} - {Math.max(0, PHASES.length - phaseIdx)} milestone{(PHASES.length - phaseIdx) !== 1 ? "s" : ""} remaining
        </p>
      </div>
    </div>
  );
            ...
            <div className="flex flex-1 min-h-0 overflow-hidden">
              ...
              <div className="w-72 flex flex-col bg-white flex-shrink-0">
                <div className="px-5 py-3 border-b border-gray-100 bg-gray-50">
                  <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Mentor Feedback</p>
                </div>
